		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "favogamesAPP",
									"targetURL": "#projecterp2v2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projecterp2v2-display": {
								"semanticObject": "projecterp2v2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projecterp2v2",
									"url": sap.ui.require.toUrl("projecterp2v2")
								}
							}
						}
					}
